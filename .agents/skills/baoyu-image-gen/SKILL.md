...
| `ZAI_WATERMARK_ENABLED` | Whether Z.AI adds its visible and invisible AI watermarks (default `true`). Set to `false` only after completing Z.AI's official watermark-removal authorization. |
